...
> Steam → Ostranauts → Свойства → Локальные файлы → Проверить целостность файлов

**Удаление перевода вручную:**
...
- **Кеширование условий** — 460K+ попаданий в кеш, 99.8% hit rate
- **ParseCondEquation cache** — 403K попаданий, 97% hit rate
- **CondRule cache** — 28K попаданий, 98.4% hit rate
